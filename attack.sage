...
class ExperimentStarter:
    ...
    def poseidon_system(self, prime, num_rounds):
        # For modeling with minimum variables, use the following code.
        R_F, R_P = (2, 9)
        self.capacity = 2
        self.rate = 1
...
if __name__ == "__main__":
    ...
    while not memory_exhausted and r == 1:
        num_rounds = r
        if primitive_name == "poseidon":
